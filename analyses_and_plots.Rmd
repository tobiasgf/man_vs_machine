...
redlist <- read.table(here::here("data","dk_redlist.csv"),sep=',',header=T,as.is=TRUE,row.names = 1)
...
env <- read.csv(here::here("data","environmental_variables.txt"),sep='\t',header=T,as.is=TRUE)
...
top_phyl  <- read.csv(here::here("data","top50_phylum_20190110.txt"),sep='\t',header=T,as.is=TRUE) #read table
top_class  <- read.csv(here::here("data","top50_class_20190110.txt"),sep='\t',header=T,as.is=TRUE) #read table
top_order  <- read.csv(here::here("data","top50_order_20190110.txt"),sep='\t',header=T,as.is=TRUE) #read table
